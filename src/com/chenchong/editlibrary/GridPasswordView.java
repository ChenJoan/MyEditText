package com.chenchong.editlibrary;
...
public class GridPasswordView extends LinearLayout implements PasswordView {
	/** 默认的输入框长度 */
    private static final int DEFAULT_PASSWORDLENGTH = 5;//输入框的长度
...
//        view.setTransformationMethod(transformationMethod);//设置输入内容不可见，显示●
        view.setTransformationMethod(HideReturnsTransformationMethod.getInstance());//设置输入内容可见
    }
